...
% Use the EB Garamond font from your system and define all required shapes
\setmainfont{EB Garamond}[
  ...
  FontFace         = {sb}{it}{ Font = {* SemiBold Italic} }
]

% Set a matching, scalable math font to avoid size substitution warnings

...
\experience{
    \role{{\mainBullet} Machine Learning Engineer (Contract) at \tech{Pinterest}}{}{June 2025 -- Present}{     
        
        \achievement{
            Improved a key search relevance metric for Women's Fashion business vertical by providing quality training data from an LLM-as-a-Judge to the recommendation model.
        }
    }
}

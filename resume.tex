...
\section{Skills}
\achievementSkill{
\tech{Prgramming Languages}: Python (Fluent), C/C++ (Familiar), JavaScript (Prior experience)
}\vspace{-6pt}
\achievementSkill{
\tech{AI / ML Frameworks}: PyTorch, Keras, HuggingFace (transformers, PEFT), spaCy, LangGraph, Flask, Sanic, SQLAlchemy
}\vspace{-6pt}
% \achievementSkill{
% \tech{Generative AI}: RAG Evaluation (RAGAs), Model Serving (vLLM)
% }\vspace{-6pt}
\achievementSkill{
\tech{MLOps \& Cloud}: Docker, Kubernetes, Elastic Container Services, Kubeflow, AWS, GCP, Vertex AI
}\vspace{-6pt}
\achievementSkill{
\tech{Databases \& Vector Stores}: BigQuery, PostgreSQL, Firestore, Redis, ChromaDB
}\vspace{-6pt}
    \vspace{5pt}
...
\experience{
    ...
    \role{MASc Computer Engineering}{University of Toronto}
    {May 2023 -- Jun 2025}{
        \achievement{
            \textbf{Thesis}: \href{https://files.zafarmahmood.com/thesis.pdf}{A Fully Generative Counsellor Chatbot for Smoking Cessation and LLM-Based Synthetic Smokers} \hspace{1pt}\textbar\hspace{1pt}  {\href{https://files.zafarmahmood.com/TRWOU2SP-redacted.pdf}{\textbf{GPA}: 4.0/4.0 \tech{\ExternalLink}}
        }}
        
        \achievement{
            Deployed a multi-agent therapeutic chatbot \cite{mahmood2025fullygenerativemotivationalinterviewing} on \tech{AWS ECS}, which helped smokers increase their confidence in quitting smoking by 1.7 (0-10 scale). Improved chatbot's therapeutic quality by 26\% by implementing \tech{ReAct} for counsellor behaviour selection.
        }
        \achievement{
...
\experience{
    \role{ML Engineer (Contract)}{Pinterest / Innodata Inc.}{Jun 2025 -- Present}{     
...
\experience{
    \role{NLP Engineer}{Dialpad Canada Inc.}{Apr 2019 -- Apr 2023}{     
...
\experience{
    \role{Data Scientist}{                          Exzeo Software Pvt. Ltd.                 }{Jun 2018 -- Mar 2019}{
        \achievement{
        Designed a text-based, omni-channel conversational agent using \tech{Google DialogFlow} to help customers file insurance claims.
        }
...
\section{Projects}
    ...
    \project{\href{https://github.com/zaffnet/qareen}{\texttt{qareen}: A Framework to Discover Relevant and Diverse Multimodal Few-shot Examples. \tech{\ExternalLink}}}
        {2025}
        {\achievement{\texttt{qareen} solves the problem of balancing relevance and diversity in few-shot selection using Maximum Marginal Relevance (MMR). It supports two strategies for combining text and image signals: Weighted Linear Combination and Reciprocal Rank Fusion (RRF).}
        }
    \project{\href{https://www.eecg.utoronto.ca/~jayar/ece1786.2023/download/autoannomi.pdf}{AutoAnnoMI: Automating Annotations of MI Conversations using LLMs \tech{\ExternalLink}}}
    {2023}
    ...
    \project
    {\href{https://zaffnet.github.io/batch-normalization}{Benchmarking Batch Renormalization \tech{\ExternalLink}}}{2017}
...
\project
    {\href{https://www.kaggle.com/c/donorschoose-application-screening/discussion/55396}{Best Kernel Award, Kaggle}}{2018}
